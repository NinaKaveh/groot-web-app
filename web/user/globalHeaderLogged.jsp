        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item active" style="margin-right:10px">
                    <a class="nav-link" href="${pageContext.request.contextPath}/user/welcome.jsp">My Homepage</a>
                </li>
                <li class="nav-item" style="margin-right:10px">
                    <a class="nav-link" href="${pageContext.request.contextPath}/user/profile.jsp">Profile</a>
                </li>
                <li class="nav-item" style="margin-right:10px">
                    <a class="nav-link" href="${pageContext.request.contextPath}/user/allarticles.jsp">Articles</a>
                </li>
                <li class="nav-item" style="margin-right:10px">
                    <a class="nav-link" href="${pageContext.request.contextPath}/user/allevents.jsp">Events</a>
                </li>
                <li class="nav-item" style="margin-right:10px">
                    <a class="nav-link" href="${pageContext.request.contextPath}/user/score.jsp">Scores</a>
                </li>
            </ul>
